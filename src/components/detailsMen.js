...
class DetailsMen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            _id:'',
    ...
    componentDidMount() {
        let details = this.props.men.filter(mens => mens._id === this.props.match.params.mensId)
              this.setState({
            _id:details[0]._id,
    ...
    componentDidUpdate = (prevProps) => {
        if (this.props.match.params.mensId != prevProps.match.params.mensId || this.props.men != prevProps.men) {
            let details = this.props.men.filter(mens => mens._id === this.props.match.params.mensId)
            this.setState({
                _id:details[0]._id,
                image:details[0].image,
...
export default (connect(mapStateToProps, {})(withRouter(DetailsMen)));
