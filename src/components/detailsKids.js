...
class DetailsKids extends Component {
    constructor(props) {
        super(props);
        this.state = {
            _id: '',
    ...
    componentDidMount() {
        let details = this.props.kid.filter(kids => kids._id === this.props.match.params.kidsId)
        this.setState({
            _id: details[0]._id,
    ...
    componentDidUpdate = (prevProps) => {
        if (this.props.match.params.kidsId != prevProps.match.params.kidsId || this.props.kid != prevProps.kid) {
            let details = this.props.kid.filter(kids => kids._id === this.props.match.params.kidsId)
            this.setState({
                _id: details[0]._id,
                image: details[0].image,
...
export default (connect(mapStateToProps, {})(withRouter(DetailsKids)));
