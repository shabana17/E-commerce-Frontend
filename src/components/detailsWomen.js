...
class DetailsWomen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            _id: '',
    ...
    componentDidMount() {
        let details = this.props.women.filter(womens => womens._id === this.props.match.params.womensId)
        this.setState({
            _id: details[0]._id,
    ...
    componentDidUpdate = (prevProps) => {
        if (this.props.match.params.womensId != prevProps.match.params.womensId || this.props.women != prevProps.women) {
            let details = this.props.women.filter(womens => womens._id === this.props.match.params.womensId)
            this.setState({
                _id: details[0]._id,
                image: details[0].image,
...
export default (connect(mapStateToProps, {})(withRouter(DetailsWomen)));
